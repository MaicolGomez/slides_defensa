...
plot \
newhistogram "2DCONV" font ",28" lt 3, '2dconv_iris.dat' u (100.*($4/$2)) notitle lc rgb '#F4A460', "" u (100.*($3/$2)) notitle lc rgb '#87CEEB',\
newhistogram "ATAX" font ",28", 'atax_iris.dat'u (100.*$4/$2) notitle lc rgb '#F4A460', "" u (100.*$3/$2) notitle lc rgb '#87CEEB',\
newhistogram "BICG" font ",28", 'bicg_iris.dat' u (100.*$4/$2) notitle lc rgb '#F4A460', "" u (100.*$3/$2) notitle lc rgb '#87CEEB',\
newhistogram "MVT" font ",28", 'mvt_iris.dat' u (100.*$4/$2) t "OpenCL" lc rgb '#F4A460', "" u (100.*$3/$2) t "Kernel" lc rgb '#87CEEB', \
